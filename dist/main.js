...
const getTasks = (projID) => {
    if (projID.startsWith('proj')) return _storage__WEBPACK_IMPORTED_MODULE_3__.Storage.getProject(projID).getTasks();
    if (projID === 'Today') {
...
/* harmony import */ var _Octocat_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Octocat.png */ "./src/Octocat.png");
...
const _createFooter = () => {
    ...
    img.type = "image";
    img.alt = "Github";
    img.src = _Octocat_png__WEBPACK_IMPORTED_MODULE_2__;
...
const Storage = {
    loadSampleProjects: () => {
        ...
        Storage.addProject((0,_project__WEBPACK_IMPORTED_MODULE_0__.Project)('proj1', 'Household'));
        Storage.addProject((0,_project__WEBPACK_IMPORTED_MODULE_0__.Project)('proj2', 'Odin Project'));
        Storage.addProject((0,_project__WEBPACK_IMPORTED_MODULE_0__.Project)('proj3', 'Holidays'));
        Storage.addProject((0,_project__WEBPACK_IMPORTED_MODULE_0__.Project)('proj4', 'Vacation'));
        
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task1', 'Garbage', 'Take garbage out to street','2021-12-31', 'p3', 'proj1'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task2', 'Bathroom Floors', 'Clean bathroom floors','2021-12-23', 'p1', 'proj1'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task3', 'Kitchen Floors', 'Clean kitchen floors','2021-12-27', 'p2', 'proj1'));

        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task4', 'SOLID', 'Read and understand SOLID principles', '2021-12-30', 'p1', 'proj2'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task5', 'CSS', 'Play around / get familiar with Flexbox', '2022-01-05', 'p2', 'proj2'));

        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task6', 'Gifts', 'Buy christmas gifts for partner','2021-12-23', 'p1', 'proj3'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task7', 'Wrapping', 'Wrap all gifts and attach bowtie','2021-12-23', 'p2', 'proj3'));

        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task8', 'Vacation', 'Buy tickets to Mexico','2022-01-31', 'p3', 'proj4'));

        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task9', 'Todo list', 'Finish up todo list project','2021-12-22', 'p1', 'projInbox'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task10', 'Javascript', 'Get familiar with advanced javascript methods','2021-12-28', 'p2', 'projInbox'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task11', 'Tennis', 'Reserve court and schedule next league match','2021-12-24', 'p3', 'projInbox'));
        taskList.push((0,_task__WEBPACK_IMPORTED_MODULE_1__.Task)('task12', 'Call back Tim', '','2022-01-15', 'p4', 'projInbox'));
...
const Schedule = () => {
    ...
    const proto = {
        ...
        getFormattedDate(date) {
            const ISODate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date);
            const todayColor = '#cf4e26';
            const pastColor = '#cf4e26';
            const upcomingColor = '#bb4ade';

            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(ISODate)) return ['Today', todayColor];
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(ISODate)) return [(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d y'), pastColor];
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(ISODate, today) <= 7) return [(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'EEEE'), upcomingColor]; 
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(ISODate)) return [(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d'), 'default'];
            return [(0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d y'), 'default'];
        },
        isThisWeek(date) {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date));
        }
    }
    return Object.create(proto);
}
...
const updateProjQty = () => {
    document.querySelectorAll('.projQty').forEach(projNumber => {
        ...
        projNumber.textContent = _storage__WEBPACK_IMPORTED_MODULE_2__.Storage.getProject(projID).getTasks().length;
    })
}
