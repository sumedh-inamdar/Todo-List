...
const Schedule = () => {
    ...
    const proto = {
        ...
        getFormattedDate(date) {
            ...
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(ISODate)) return 'Today';
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(ISODate)) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d y');
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(ISODate, today) <= 7) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'EEEE'); 
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(ISODate)) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d');
...
const render = (() => {
    ...
    // sample inbox tasks
    const task1 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task1', 'Garbage', 'Take garbage out to street','2021-12-31', 'p3', 'projInbox');
    const task2 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task2', 'Bathroom Floors', 'Clean bathroom floors','2021-12-09', 'p1', 'projInbox');
    const task3 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task3', 'Kitchen Floors', 'Clean kitchen floors','2021-12-31', 'p2', 'projInbox');
    const task4 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task4', 'Vacation', 'Buy ticket to Mexico','2021-12-31', 'p3', 'projInbox');
