...
const setupNavEventListeners = () => {
    ...
    inboxNode.addEventListener('click', _appLogic__WEBPACK_IMPORTED_MODULE_0__.displayProject);
...
const Schedule = () => {
    ...
    const proto = {
        ...
        getFormattedDate(date) {
            ...
            const daysFromToday = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(ISODate, today);

            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(ISODate)) return 'Today';
            if (daysFromToday <= 7) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'EEEE'); 
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(ISODate)) return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d');
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(ISODate, 'MMM d y')
        },
        isThisWeek(date) {
            return (0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(date));
        }
...
const updateProjectList = () => {
    ...
    _storage__WEBPACK_IMPORTED_MODULE_2__.Storage.getProjects().forEach(proj => {
        if(proj.getID() !== 'projInbox') parentNode.insertBefore((0,_createDOM__WEBPACK_IMPORTED_MODULE_0__.createProject)(proj), refNode);
    });
...
const updateTaskList = (dispID) => {
    ...
    closeTaskForms();
    removeTaskItems();
    addTaskItems((0,_appLogic__WEBPACK_IMPORTED_MODULE_3__.getTasks)(currDispID));
...
const render = (() => {
    ...
    // sample inbox tasks
    const task1 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task1', 'Garbage', 'Take garbage out to street','2021-12-08', 'p1', 'projInbox');
    const task2 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task2', 'Bathroom Floors', 'Clean bathroom floors','2021-12-09', 'p2', 'projInbox');
    const task3 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task3', 'Kitchen Floors', 'Clean kitchen floors','2021-12-31', 'p3', 'projInbox');
    const task4 = (0,_modules_task_js__WEBPACK_IMPORTED_MODULE_2__.Task)('task4', 'Vacation', 'Buy ticket to Mexico','2022-01-28', 'p3', 'projInbox');
    ...
    _modules_storage_js__WEBPACK_IMPORTED_MODULE_0__.Storage.getProject(inbox.getID()).addTask(task4);
    ...
    _modules_storage_js__WEBPACK_IMPORTED_MODULE_0__.Storage.addTaskID('task4');
